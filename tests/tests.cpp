//
// Created by 79933 on 2026/1/7.
//

#include "gtest/gtest.h"
#include "flexraywrapper/flexraywrapper.h"

TEST(findAllChannel, MTestServerDeviceFlexRay){
    char chnStr[2000];
    int32_t chnCount = 0;
    fr_find_all_channels(chnStr, &chnCount);
    std::cout << "channel count: " << chnCount << std::endl;
    std::cout << chnStr << std::endl;
}

TEST(communication, MTestServerDeviceFlexRay){
    ...
    fr_set_channel_config(&channel0, "tosun0 flexray0", chnConfig0, &clusterConfig, &ecuConfig);
    fr_open_channel(channel0);
    fr_set_channel_config(&channel1, "tosun1 flexray1", chnConfig1, &clusterConfig, &ecuConfig);
...
//            std::cout << "slot: " << slot << " cycle: " << static_cast<int>(cycle) << " dataLength: " << static_cast<int>(dataLength) << std::endl;
//            std::cout << "data: ";
//            for (int j = 0; i < dataLength; j++)
//                std::cout << static_cast<int>(data_r[j]) << ' ';
//            std::cout << std::endl;
//        }
//        std::cout << "receive round: " << i << std::endl;
//        fr_get_message(channel0, &slot0, &cycle, &dataLength, data_r, 100);
//        std::cout << "slot: " << slot0 << " cycle: " << static_cast<int>(cycle) << " dataLength: " << static_cast<int>(dataLength) << std::endl;
//        std::cout << "data: ";
//        for (uint32_t j = 0; j < dataLength; j++)
//            std::cout << static_cast<int>(data_r[j]) << ' ';
//        std::cout << std::endl;
//        fr_get_message(channel1, &slot1, &cycle, &dataLength, data_r, 100);
//        std::cout << "slot: " << slot1 << " cycle: " << static_cast<int>(cycle) << " dataLength: " << static_cast<int>(dataLength) << std::endl;
//        std::cout << "data: ";
//        for (uint32_t j = 0; j < dataLength; j++)
//            std::cout << static_cast<int>(data_r[j]) << ' ';
//        std::cout << std::endl;
