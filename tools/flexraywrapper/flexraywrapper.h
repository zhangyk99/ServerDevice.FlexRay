...
FLEXRAYDLL int32_t FindAllChannels(char *str, int32_t *chnCount);
...
FLEXRAYDLL int32_t CloseChannel(void *channel);

FLEXRAYDLL int32_t SetMessage(void *channel, uint16_t sold, uint8_t cycle, uint8_t dataLength, uint8_t *data, int32_t timeout);

FLEXRAYDLL int32_t SetMessages(void *channel, uint16_t item, uint16_t *sold, uint8_t *cycle, uint8_t *dataLength, uint8_t *data, int32_t timeout);

FLEXRAYDLL int32_t GetMessage_(void *channel, uint16_t *sold, uint8_t *cycle, uint8_t *dataLength, uint8_t *data, int32_t timeout);

FLEXRAYDLL int32_t GetMessages(void *channel, uint16_t *item, uint16_t *sold, uint8_t *cycle, uint8_t *dataLength, uint8_t *data, int32_t timeout);
